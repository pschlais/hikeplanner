"""Django project settings - base/common variables
...
SECRET_KEY = os.environ.get("HIKEPLANNER_SECRET_KEY")
...
WSGI_APPLICATION = 'hikeplanner.wsgi.application'
