# Generated by Django 2.0.3 on 2018-08-16 01:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=5000)),
                ('county', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='planner.County')),
                ('destination', models.ForeignKey(help_text='Destinations accessible by this route', on_delete=django.db.models.deletion.CASCADE, to='planner.Destination', verbose_name='Accessible Destination(s)')),
        ...
        migrations.AddField(
            model_name='route',
            name='trailhead',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='planner.Trailhead'),
        ),
        migrations.AddField(
